...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) ,ui(new Ui::MainWindow)
{
    ...
    listModel->setStringList(MainPageListModelEnglish);
...
void MainWindow::on_upButton_clicked()
{
    ...
    if(currentOption < MainPageListModelEnglish.size()) {
        previousOption--;
    }
    ...
    int preOption = currOption;

    if(currentOption < SettingPageListModel.size()) {
        preOption--;
    }

    ui->settingMenu->selectRow(preOption);
