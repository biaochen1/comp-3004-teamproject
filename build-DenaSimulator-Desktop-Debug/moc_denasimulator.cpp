...
void DenaSimulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DenaSimulator *_t = static_cast<DenaSimulator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DenaSimulator::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_DenaSimulator.data,
      qt_meta_data_DenaSimulator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DenaSimulator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DenaSimulator.stringdata0))
        return static_cast<void*>(const_cast< DenaSimulator*>(this));
