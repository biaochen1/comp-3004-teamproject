...
public:
    ...
    void setupUi(QMainWindow *DenaSimulator)
    {
        ...
        batteryLevel->setGeometry(QRect(180, 450, 118, 23));
        ...
        menubar->setGeometry(QRect(0, 0, 478, 38));
    ...
    void retranslateUi(QMainWindow *DenaSimulator)
    {
        ...
        counterLabel->setText(QCoreApplication::translate("DenaSimulator", "Treatment", nullptr));
